                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <table class="table table-striped table-hover">
                                            <tr>
                                                <td>Image ID</td>
                                                <td>
                                                    <input readonly="" name="ImageId" value="${param.ID}" />
                                                </td> 
                                            </tr>
                                            <tr>
                                                <td>URL</td>
                                                <td>
                                                    <input  name="Url" value="${user.getUrl()}"  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Status</td>
                                            ...
                                            <tr>
                                                <td>Book</td>
                                                <td>
                                                    <input  name="BookId" value="${user.getBookId()}"  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <button type="submit" name="btAction" value="Manage Image">BACK</button>
                                                </td>
                                                <td>
                                                    <button type="submit" name="btAction" value="ManageUpdateImage">UPDATE</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
