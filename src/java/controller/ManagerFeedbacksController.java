 ...
 * @author THUAN
 */
public class ManagerFeedbacksController extends HttpServlet {

    private final String MANAGER_PAGE = "ManagerFeedbacks.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerFeedbacksController.class.getName()).log(Level.SEVERE, null, ex);
